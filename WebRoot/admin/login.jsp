	...
	<div class="account-pages">
	  <div class="wrapper-page">
		<div class="text-center">
	      <a href="javascript:void(0);" class="logo"><span>Admin</span></a>
	    </div>
	    <div class="m-t-40 card-box">
	      ...
	      <div class="panel-body">
	        <form class="am-form" method="post" action="${ctx }/admin/login">
              <div class="am-g">
                <div class="am-form-group">
		          <input type="text" name="nickname" class="am-radius"  placeholder="Username">
		        </div>
